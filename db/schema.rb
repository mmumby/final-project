...
ActiveRecord::Schema.define(version: 20170823172716) do
  ...
  create_table "chatrooms", force: :cascade do |t|
    ...
    t.integer  "owner_id"
    t.integer  "client_id"
    t.index ["claim_id"], name: "index_chatrooms_on_claim_id", using: :btree
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "uid"
    t.string   "name"
    t.text     "image",                  default: "/images/default_profile_normal.png"
    t.index ["email"], name: "index_users_on_email", unique: true, using: :btree
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true, using: :btree
  end

  add_foreign_key "chatrooms", "claims"
